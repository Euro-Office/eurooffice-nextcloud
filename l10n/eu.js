OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Euro-Office aplikazioa ez dago konfiguratuta. Mesedez, jarri administradorearekin harremanetan",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Ezin da Euro-Office-era iritsi. Mesedez, jarri administradorearekin harremanetan",
    "Loading, please wait." : "Kargatzen, itxaron mesedez.",
    "File created" : "Fitxategia sortuta",
    "Open in Euro-Office" : "Ireki Euro-Office-ekin",
    "Convert with Euro-Office" : "Bihurtu Euro-Office-ekin",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Docs-en kokapenak dokumentu zerbitzuak instalatuta daude zerbitzariaren helbidea zehazten du. Mesedez, aldatu '<documentserver>' zerbitzariaren helbideagatik beheko lerroan.",
    "Euro-Office Docs address" : "Euro-Office Docs-en helbidea",
    "Advanced server settings" : "Zerbitzariaren ezarpen aurreratuak",
    "Euro-Office Docs address for internal requests from the server" : "Euro-Office Docs-en helbidea zerbitzariaren barneko eskaeretarako",
    "Server address for internal requests from Euro-Office Docs" : "Zerbitzariaren helbidea Euro-Office Docs-en barneko eskaeretarako",
    ...
    "Save" : "Gorde",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Eduki Nahasi Aktiboa ez da onartzen. Euro-Office Docs-erako HTTPS helbidea behar da.",
    ...
    "Connect to demo Euro-Office Docs server" : "Konektatu Euro-Office Docs demo zerbitzarira",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "30 eguneko probaldia amaitu da, ezin zara Euro-Office Docs demo zerbitzarira gehiago konektatu",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Euro-Office Docs demo zerbitzari publikoa erabiltzen ari zara. Mesedez, ez gorde zure datu konfidentzialak hemen.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Erabili Euro-Office dokumentuaren aurrebista sortzeko (diskoan lekua hartuko du)",
    ...
    "group": "taldea",
    "Advanced": "Aurreratua",
    "Provide advanced document permissions using Euro-Office Docs": "Eman baimen aurreratuak dokumentuei Euro-Office Docs erabiliz",
    ...
    "Euro-Office server is not available": "Euro-Office zerbitzaria ez dago eskuragarri",
    ...
    "Euro-Office Document Server is unavailable": "Euro-Office dokumentu-zerbitzaria ez dago eskuragarri",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Mezu elektroniko honen bidez jakinarazten dizugu Euro-Office dokumentu-zerbitzariarekiko konexioa galdu dela. Mesedez, berrikusi konexio ezarpenak:",
