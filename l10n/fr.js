OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "L'application Euro-Office n'est pas configuré. Veuillez contacter votre administrateur",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Euro-Office est indisponible. Veuillez contacter votre administrateur",
    "Loading, please wait." : "Chargement, veuillez patienter.",
    "File created" : "Fichier créé",
    "Open in Euro-Office" : "Ouvrir dans Euro-Office",
    "Convert with Euro-Office" : "Convertir avec Euro-Office",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "L'emplacement du Euro-Office Docs désigne l'adresse du serveur sur lequel est installé le service de document. Veuillez modifier le '<documentserver>' avec l'adresse du serveur de service de document dans la ligne ci-dessous",
    "Euro-Office Docs address" : "Adresse du Euro-Office Docs",
    "Advanced server settings" : "Paramètres avancés du serveur",
    "Euro-Office Docs address for internal requests from the server" : "Adresse du Euro-Office Docs pour les demandes internes du serveur",
    "Server address for internal requests from Euro-Office Docs" : "Adresse du serveur pour les demandes internes du Euro-Office Docs",
    ...
    "Save" : "Enregistrer",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Le contenu mixte actif n'est pas autorisé. Une adresse HTTPS pour le Euro-Office Docs est requise",
    ...
    "Connect to demo Euro-Office Docs server" : "Se connecter à la version démo de Euro-Office Docs",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "La période d'essai de 30 jours est expirée, vous n'êtes plus en mesure de vous connecter à la version démo de Euro-Office Docs.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Vous utilisez la version démo de Euro-Office Docs, proposée à des fins de tests. Veuillez ne pas stocker vos données confidentielles.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Utilisez Euro-Office pour générer l'aperçu du document (occupe de l'espace disque)",
    ...
    "group": "groupe",
    "Advanced": "Avancé",
    "Provide advanced document permissions using Euro-Office Docs": "Fournir des autorisations avancées pour les documents en utilisant Euro-Office Docs",
    ...
    "Euro-Office server is not available": "Le serveur Euro-Office n'est pas disponible",
    ...
    "Euro-Office Document Server is unavailable": "Euro-Office Document Server n'est pas disponible",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Ceci est un message pour vous informer que la connexion avec Euro-Office Document Server a été interrompue. Veuillez vérifier les paramètres de connexion :",
    ...
    "Welcome to Euro-Office Docs!": "Bienvenue dans Euro-Office Docs !",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office Docs.": "Modifiez et collaborez sur des documents texte, des feuilles de calcul, des présentations et des fichiers PDF dans Nextcloud à l'aide de Euro-Office Docs.",
    ...
    "To ensure the security of important parameters in Euro-Office Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Pour garantir la sécurité des paramètres importants dans les requêtes Euro-Office Docs, veuillez définir une clé secrète sur la page Paramètres. Pour en savoir plus, <a href=\"{url}\" target=\"_blank\">cliquez ici</a>.",
    "Info": "Information",
    "Open": "Ouvrir",
