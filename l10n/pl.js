OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "OAplikacja Euro-Office nie jest skonfigurowana. Skontaktuj się z administratorem",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Euro-Office jest nieosiągalny. Skontaktuj się z administratorem",
    "Loading, please wait." : "Ładowanie, proszę czekać.",
    "File created" : "Plik utworzony",
    "Open in Euro-Office" : "Otwórz w Euro-Office",
    "Convert with Euro-Office" : "Konwertuj",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Lokacja Euro-Office Docs to adres serwera na którym Usługi Dokumentów są zainstalowe. Proszę zmienić '<documentserver>' na adres poniżej.",
    "Euro-Office Docs address" : "Adres Euro-Office Docs",
    "Advanced server settings" : "Zaawansowane ustawienia serwera",
    "Euro-Office Docs address for internal requests from the server" : "Adres Euro-Office Docs dla zapytań wewnętrznych",
    "Server address for internal requests from Euro-Office Docs" : "Adres serwera dla zapytań wewnętrznych z Euro-Office Docs",
    ...
    "Save" : "Zapisz",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Aktywna Zawartość Mieszana nie jest dozwolona. Adres HTTPS jest wymagany dla Euro-Office Docs.",
    ...
    "Connect to demo Euro-Office Docs server" : "Połącz się z serwerem demo Euro-Office Docs",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "Upłyneło 30 dni, nie możesz się już łączyć z serwerem demo.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Używasz publicznego serwera demo. Nie przechowuj tu prywatnych danych.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Skorzystaj z Euro-Office, aby wygenerować podgląd dokumentu (zajmie to miejsce na dysku)",
    ...
    "Provide advanced document permissions using Euro-Office Docs": "Udziel zaawansowanych uprawnień do edycji dokumentów w Euro-Office Docs",
    ...
    "Euro-Office server is not available": "Serwer Euro-Office jest niedostępny",
    ...
    "Euro-Office Document Server is unavailable": "Serwer dokumentów Euro-Office jest niedostępny",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "To jest wiadomość e-mail informująca, że połączenie z serwerem dokumentów Euro-Office zostało utracone. Proszę sprawdzić ustawienia połączenia:",
    ...
    "Welcome to Euro-Office Docs!": "Witaj w Euro-Office Docs!",
