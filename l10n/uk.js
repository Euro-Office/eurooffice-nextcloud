OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Застосунок Euro-Office не налаштовано. Будь ласка, сконтактуйте з адміністратором",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Неможливо встановити з'єднання з Euro-Office. Будь ласка, сконтактуйте з адміністратором.",
    "Loading, please wait." : "Триває завантаження. Будь ласка, зачекайте.",
    "File created" : "Файл створено",
    "Open in Euro-Office" : "Відкрити у Euro-Office",
    "Convert with Euro-Office" : "Конвертувати у Euro-Office",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Розташування Euro-Office Docs визначає адресу сервера зі встановленими службами документів. Будь ласка, замініть '<documentserver>' на дійсну адресу сервера.",
    "Euro-Office Docs address" : "Адреса Euro-Office Docs",
    "Advanced server settings" : "Додаткові налаштування сервера",
    "Euro-Office Docs address for internal requests from the server" : "Адреса Euro-Office Docs для внутрішніх запитів сервера",
    "Server address for internal requests from Euro-Office Docs" : "Адреса сервера для внутрішніх запитів Euro-Office Docs",
    ...
    "Save" : "Зберегти",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Змішаний активний вміст заборонено. Для користування Euro-Office Docs потрібно використовувати безпечне з'єднання HTTPS.",
    ...
    "Connect to demo Euro-Office Docs server" : "З'єднатися з демонстраційним сервером Euro-Office Docs",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "Тестовий 30-денний період вичерпано. Ви більше не маєте змоги з'єднуватися з демонстраційним сервером Euro-Office Docs",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Ви використовуєте ПУБЛІЧНИЙ демонстраційний сервер Euro-Office Docs. Будь ласка, не зберігайте ваші приватні дані.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Euro-Office створюватиме зображення попереднього перегляду документу (потрібне місце на диску)",
    ...
    "group": "група",
    "Advanced": "Додатково",
    "Provide advanced document permissions using Euro-Office Docs": "Увімкнути розширені права доступу до документів у Euro-Office Docs",
    ...
    "Euro-Office server is not available": "Сервер Euro-Office не доступний",
    ...
    "Euro-Office Document Server is unavailable": "Сервер документів Euro-Office недоступний",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Цим листом повідомляємо вам, що з'єднання з сервером документів Euro-Office втрачено. Перевірте параметри з'єднання:",
