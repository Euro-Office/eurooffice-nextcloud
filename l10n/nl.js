OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin": "Euro-Office app is niet geconfigureerd. Neem contact op met de admin",
    ...
    "Euro-Office cannot be reached. Please contact admin": "Euro-Office kan niet worden bereikt. Neem contact op met de admin",
    "Loading, please wait.": "Laden, wacht alstublieft.",
    "File created": "Bestand Aangemaakt",
    "Open in Euro-Office": "Openen in Euro-Office",
    "Convert with Euro-Office": "Converteer met Euro-Office",
    ...
    "Euro-Office Docs address": "Euro-Office Docs adres",
    "Advanced server settings": "Geavanceerde serverinstellingen",
    "Euro-Office Docs address for internal requests from the server": "Adres van de Euro-Office Docs voor interne verzoeken van de server",
    "Server address for internal requests from Euro-Office Docs": "Serveradres voor interne verzoeken van de Euro-Office Docs",
    ...
    "Save": "Opslaan",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required.": "Gemende Actieve Inhoud is niet toegestaan. HTTPS-adres voor Euro-Office Docs is vereist.",
    ...
    "Connect to demo Euro-Office Docs server": "Verbinden met de demo Euro-Office Docs server",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server.": "De 30-dagen proefperiode is voorbij, u kunt niet langer verbinding maken met demo Euro-Office Docs server.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data.": "U gebruikt de openbare demo Euro-Office Docs server. Sla geen vertrouwelijke gegevens op.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Gebruik Euro-Office om een voorbeeld van een document te genereren (dit neemt schijfruimte in beslag)",
    ...
    "Provide advanced document permissions using Euro-Office Docs": "Geavanceerde documentrechten geven met Euro-Office Docs",
    ...
    "Euro-Office server is not available": "Euro-Office server is niet beschikbaar",
    ...
    "Euro-Office Document Server is unavailable": "Euro-Office Document Server is niet beschikbaar",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Dit is een e-mailbericht om te melden dat de verbinding met de Euro-Office Document Server verbroken is. Controleer de verbindingsinstellingen:",
    ...
    "Welcome to Euro-Office Docs!": "Welkom bij Euro-Office Docs!",
