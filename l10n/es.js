OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Aplicación Euro-Office no está configurada. Por favor, contacte con admin",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "No se puede acceder al Euro-Office. Por favor, contacte con admin",
    "Loading, please wait." : "Cargando, espere, por favor.",
    "File created" : "Archivo creado",
    "Open in Euro-Office" : "Abrir en Euro-Office",
    "Convert with Euro-Office" : "Convertir con Euro-Office",
    ...
    "Save" : "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Contenido Mixto Activo no está permitido. Se requiere la dirección HTTPS para Euro-Office Docs.",
    ...
    "Connect to demo Euro-Office Docs server" : "Conectarse al servidor de Euro-Office Docs de demostración",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "El período de prueba de 30 días ha terminado, ya no puedes conectarte al servidor de Euro-Office Docs de demostración",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Estás usando el servidor de Euro-Office Docs de demostración. Por favor, no almacenes tus datos confidenciales aquí.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Usar Euro-Office para generar una vista previa del documento (ocupará espacio en el disco)",
    ...
    "group": "grupo",
    "Advanced": "Avanzado",
    "Provide advanced document permissions using Euro-Office Docs": "Proporcione permisos avanzados para los documentos utilizando Euro-Office Docs",
    ...
    "Euro-Office server is not available": "El servidor de Euro-Office no está disponible",
    ...
    "Euro-Office Document Server is unavailable": "El Servidor de documentos Euro-Office no está disponible",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Este es un mensaje de correo electrónico para notificarle que la conexión con el Servidor de documentos Euro-Office se ha perdido. Por favor, compruebe los ajustes de conexión:",
    ...
    "Welcome to Euro-Office Docs!": "¡Bienvenido(a) a Euro-Office Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office Docs.": "Edite y colabore en documentos de texto, hojas de cálculo, presentaciones y archivos PDF dentro de Nextcloud usando Euro-Office Docs.",
    ...
    "To ensure the security of important parameters in Euro-Office Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Para garantizar la seguridad de los parámetros importantes en las solicitudes de Euro-Office Docs, establezca una clave secreta en la página de configuración. Para obtener más información, <a href=\"{url}\" target=\"_blank\">haga clic aquí</a>.",
    "Info": "Información",
    "Open": "Abrir",
