OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Aplicação Euro-Office não está configurada. Favor contatar o administrador",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Não foi possível conectar ao Euro-Office. Favor contatar o administrador.",
    "Loading, please wait." : "Carregando, por favor aguarde.",
    "File created" : "Arquivo criado",
    "Open in Euro-Office" : "Abrir no Euro-Office",
    "Convert with Euro-Office" : "Converta com Euro-Office",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "O Endereço do Euro-Office Docs especifica o servidor onde o serviço de documentos está instalado.\nPor favor mude '<documentserver>' para o endereço do servidor na linha abaixo.",
    "Euro-Office Docs address" : "Endereço do Euro-Office Docs",
    "Advanced server settings" : "Configurações avançadas do servidor",
    "Euro-Office Docs address for internal requests from the server" : "Endereço do Euro-Office Docs para pedidos internos do servidor",
    "Server address for internal requests from Euro-Office Docs" : "Endereço do servidor para pedidos internos do Euro-Office Docs",
    ...
    "Save" : "Salvar",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Conteúdo Misto não é permitido. É necessário um endereço HTTPS para o Euro-Office Docs.",
    ...
    "Connect to demo Euro-Office Docs server" : "Conectar ao Servidor de demonstração do Euro-Office Docs",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "O período de teste de 30 dias acabou, você não pode mais se conectar ao Servidor de demonstração do Euro-Office Docs",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Você está usando o Servidor de demonstração pública. Não armazene dados confidenciais.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Usar Euro-Office para gerar uma visualização do documento (ocupará espaço em disco)",
    ...
    "group": "grupo",
    "Advanced": "Avançado",
    "Provide advanced document permissions using Euro-Office Docs": "Forneça permissões avançadas de documentos usando o Euro-Office Docs",
    ...
    "Euro-Office server is not available": "O servidor Euro-Office não está disponível",
    ...
    "Euro-Office Document Server is unavailable": "O servidor de documentos Euro-Office não está disponível",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Esta é uma mensagem de e-mail para notificar que a conexão com o servidor de documentos Euro-Office foi perdida. Verifique as configurações de conexão:",
    ...
    "Welcome to Euro-Office Docs!": "Bem-vindo ao Euro-Office Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office Docs.": "Edite e colabore em documentos de texto, planilhas, apresentações e PDFs no Nextcloud usando o Euro-Office Docs.",
    ...
    "To ensure the security of important parameters in Euro-Office Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Para garantir a segurança de parâmetros importantes nas solicitações do Euro-Office Docs, defina uma Chave Secreta na página Configurações. Para saber mais, <a href=\"{url}\" target=\"_blank\">clique aqui</a>.",
    "Info": "Informações",
    "Open": "Abrir",
