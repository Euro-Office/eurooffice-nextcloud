OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "L'applicazione Euro-Office non è configurata. Si prega di contattare l'amministratore",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Non è possibile raggiungere Euro-Office. Si prega di contattare l'amministratore",
    "Loading, please wait." : "Caricamento in corso, attendere prego",
    "File created" : "File creato",
    "Open in Euro-Office" : "Apri in Euro-Office",
    "Convert with Euro-Office" : "Converti con Euro-Office",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Docs Location specifica l'indirizzo del server con i servizi documenti installati. Modifica il '<documentserver>' con l'indirizzo del server nella riga sottostante.",
    "Euro-Office Docs address" : "Indirizzo di Euro-Office Docs",
    "Advanced server settings" : "Impostazioni avanzate del server",
    "Euro-Office Docs address for internal requests from the server" : "Indirizzo di Euro-Office Docs per le richieste interne del server",
    "Server address for internal requests from Euro-Office Docs" : "Indirizzo del server per le richieste interne da Euro-Office Docs",
    ...
    "Save" : "Salva",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Il contenuto attivo misto non è consentito. È richiesto l'indirizzo HTTPS per Euro-Office Docs.",
    ...
    "Connect to demo Euro-Office Docs server" : "Collegati alla versione demo di Euro-Office Docs",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "Il periodo di prova di 30 giorni è terminato; non è più possibile connettersi alla versione demo di Euro-Office Docs.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Stai utilizzando la versione demo pubblica di Euro-Office Docs. Non memorizzare dati sensibili privati.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Usare Euro-Office per generare anteprima documenti (occuperà spazio su disco)",
    ...
    "group": "gruppo",
    "Advanced": "Avanzate",
    "Provide advanced document permissions using Euro-Office Docs": "Fornisci autorizzazioni avanzate per i documenti utilizzando Euro-Office Docs",
    ...
    "Euro-Office server is not available": "Il server di Euro-Office non è disponibile",
    ...
    "Welcome to Euro-Office Docs!": "Benvenuto in Euro-Office Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office Docs.": "Modifica e collabora su documenti di testo, fogli di calcolo, presentazioni e PDF all'interno di Nextcloud usando Euro-Office Docs.",
    ...
    "To ensure the security of important parameters in Euro-Office Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Per garantire la sicurezza dei parametri importanti nelle richieste di Euro-Office Docs, imposta una Chiave Segreta nella pagina delle Impostazioni. Per saperne di più, <a href=\"{url}\" target=\"_blank\">clicca qui</a>.",
    "Info": "Info",
    "Open": "Apri",
