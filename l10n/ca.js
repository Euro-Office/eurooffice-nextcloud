OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin": "Aplicació Euro-Office no està configurada. Si us plau, contacti amb l'administrador",
    ...
    "Euro-Office cannot be reached. Please contact admin": "No es pot accedir a l'Euro-Office. Si us plau, contacti amb l'administrador",
    "Loading, please wait.": "Carregant, esperi, si us plau.",
    "File created": "Arxiu creat",
    "Open in Euro-Office": "Obrir en Euro-Office",
    "Convert with Euro-Office": "Convertir amb Euro-Office",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Ubicació de l'Euro-Office Docs especifica la direcció del servidor amb els serveis de documents instal·lats. Si us plau, canviï '<documentserver>' per a la direcció de servidor en la línia inferior.",
    "Euro-Office Docs address": "Direcció d'Euro-Office Docs",
    "Advanced server settings": "Ajustos de servidor avançats",
    "Euro-Office Docs address for internal requests from the server": "Direcció d'Euro-Office Docs per a sol·licituds internes del servidor",
    "Server address for internal requests from Euro-Office Docs": "Direcció de servidor per a sol·licituds internes de l'Euro-Office Docs",
    ...
    "Save": "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required.": "Contingut Mixt Actiu no està permès. Es requereix la direcció HTTPS per a Euro-Office Docs.",
    ...
    "Connect to demo Euro-Office Docs server": "Connectar-se al servidor de Euro-Office Docs de demostració",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server.": "El període de prova de 30 dies ha acabat, ja no pots connectar-te al servidor d'Euro-Office Docs de demostració",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data.": "Estàs fent servir el servidor d'Euro-Office Docs de demostració. Si us plau, no emmagatzemis les teves dades confidencials aquí.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Usar Euro-Office per a generar una vista prèvia del document (ocuparà espai en el disc)",
    ...
    "group": "agrupa",
    "Advanced": "Avançat",
    "Provide advanced document permissions using Euro-Office Docs": "Proporcioneu permisos avançats de documents mitjançant Euro-Office Docs",
    ...
    "Euro-Office server is not available": "El servidor Euro-Office no està disponible",
    ...
    "Euro-Office Document Server is unavailable": "El servidor de documents Euro-Office no està disponible",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Aquest és un missatge de correu electrònic per notificar que s'ha perdut la connexió amb el servidor de documents Euro-Office. Comproveu la configuració de connexió:",
