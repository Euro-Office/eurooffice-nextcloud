OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Euro-Office App ist nicht konfiguriert. Bitte wenden Sie sich an Ihren Administrator",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Euro-Office ist zurzeit nicht erreichbar.  Bitte wenden Sie sich an Ihren Administrator",
    "Loading, please wait." : "Laden... Bitte warten.",
    "File created" : "Erstellte Datei",
    "Open in Euro-Office" : "In Euro-Office öffnen",
    "Convert with Euro-Office" : "Mit Euro-Office umwandeln",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Docsstandort gibt die Adresse des Servers mit den installierten Dokumentdiensten an. Bitte ändern Sie '<documenterver>' für die Serveradresse in der folgenden Zeile.",
    "Euro-Office Docs address" : "Die Adresse von Euro-Office Docs",
    "Advanced server settings" : "Erweiterte Servereinstellungen",
    "Euro-Office Docs address for internal requests from the server" : "Die Adresse von Euro-Office Docs für interne Anforderungen vom Server",
    "Server address for internal requests from Euro-Office Docs" : "Serveradresse für interne Anforderungen vom Euro-Office Docs",
    ...
    "Save" : "Speichern",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Mixed Active Content ist nicht möglich. HTTPS-Adresse für Euro-Office Docs ist erforderlich.",
    ...
    "Connect to demo Euro-Office Docs server": "Verbindung zu Demo Euro-Office Docs Server herstellen",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server.": "Der 30-tägige Testzeitraum ist abgelaufen. Sie können keine Verbindung mehr zu Demo Euro-Office Docs Server herstellen.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data.": "Sie verwenden den öffentlichen Demo Euro-Office Docs Server. Bitte benutzen Sie ihn nicht zum Speichern von Ihren privaten sensiblen Daten.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Euro-Office verwenden, um eine Dokumentvorschau zu erstellen (Speicherplatz erforderlich)",
    ...
    "group": "gruppe",
    "Advanced": "Erweitert",
    "Provide advanced document permissions using Euro-Office Docs": "Erweiterte Zugriffsrechte in Euro-Office Docs vergeben",
    ...
    "Euro-Office server is not available": "Euro-Office-Server ist nicht verfügbar",
    ...
    "Euro-Office Document Server is unavailable": "Euro-Office Document Server ist nicht verfügbar",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Dies ist eine E-Mail-Nachricht, die Sie darüber informiert, dass die Verbindung mit dem Euro-Office Document Server unterbrochen wurde. Bitte überprüfen Sie die Verbindungseinstellungen:",
    ...
    "Welcome to Euro-Office Docs!": "Willkommen bei Euro-Office Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office Docs.": "Mit Euro-Office Docs können Sie Textdokumente, Tabellenkalkulationen, Präsentationen und PDFs innerhalb von Nextcloud gemeinsam bearbeiten.",
