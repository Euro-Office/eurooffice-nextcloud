OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Euro-Office-appen är inte aktiverad. Kontakta systemadministratören",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Euro-Office inte nåbar.  Kontakta systemadministratören",
    "Loading, please wait." : "Laddar... var god vänta.",
    "File created" : "Filen skapad",
    "Open in Euro-Office" : "Öppna i Euro-Office",
    "Convert with Euro-Office" : "Konvertera med Euro-Office",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Docs plats specificerar adressen till servern där Euro-Office är installerad. Ändra '<dokumentserver>' till serverns adress i nedanstående rad.",
    "Euro-Office Docs address" : "Adress till Euro-Office Docs",
    "Advanced server settings" : "Avancerade serverinställningar",
    "Euro-Office Docs address for internal requests from the server" : "Adress till Euro-Office Docs för interna förfragningar från servern",
    "Server address for internal requests from Euro-Office Docs" : "Serveradress för interna förfrågningar från Euro-Office Docs",
    ...
    "Save" : "Spara",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Blandat aktivt innehåll är inte tillåtet. HTTPS-adress till Euro-Office Docs krävs.",
    ...
    "Editor customization settings" : "Anpassningar Euro-Office ",
    ...
    "Connect to demo Euro-Office Docs server" : "Anslut till demo Euro-Office Docsserver",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "När 30-dagars testperioden är över, kan du inte längre ansluta till demo Euro-Office Docsserver.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Du använder en offentlig demo Euro-Office Docsserver. Lagra inte privat känslig information.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Använd Euro-Office för att generera en förhandsgranskning av dokument (detta använder diskutrymme)",
    ...
    "group": "grupp",
    "Advanced": "Avancerad",
    "Provide advanced document permissions using Euro-Office Docs": "Tillhandahåll avancerade dokumentbehörigheter med Euro-Office Docs",
    ...
    "Euro-Office server is not available": "Euro-Office-servern är inte tillgänglig",
    ...
    "Open file": "Öppna fil",
    "Euro-Office Document Server is unavailable": "Euro-Office Document Server är inte tillgänglig",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Detta är ett e-postmeddelande för att meddela att anslutningen till Euro-Office Document Server har förlorats. Kontrollera anslutningsinställningarna:",
