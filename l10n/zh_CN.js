OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Euro-Office未配置，请联系管理员。",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Euro-Office 服务器无法连接，请联系管理员。",
    "Loading, please wait." : "载入中，请稍后...",
    "File created" : "文件已创建",
    "Open in Euro-Office" : "用 Euro-Office 打开",
    "Convert with Euro-Office" : "用 Euro-Office 转换",
    "New document" : "新建文档",
    ...
    "Documentation" : "文档集",
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Docs 位置指定了安装了文档服务的服务器的地址，请将'<documentserver>'改为下面一行中的服务器地址。",
    "Euro-Office Docs address" : "Euro-Office Docs地址",
    "Advanced server settings" : "更多设置",
    "Euro-Office Docs address for internal requests from the server" : "服务器内部请求 Euro-Office Docs 的地址",
    "Server address for internal requests from Euro-Office Docs" : "Euro-Office Docs 内部请求服务器的地址",
    ...
    "Save" : "保存",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "不允许混合活动内容，请使用HTTPS连接Euro-Office Docs。",
    ...
    "Connect to demo Euro-Office Docs server" : "连接到 Euro-Office Docs 演示服务器",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "30天试用期已结束，无法连接Euro-Office Docs 演示服务器。",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "您正在使用 Euro-Office Docs 公开的演示服务器，请勿存储隐私数据。",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "使用Euro-Office生成文档预览（将占用磁盘空间）",
    ...
    "group": "分组",
    "Advanced": "进阶",
    "Provide advanced document permissions using Euro-Office Docs": "使用Euro-Office Docs 提供高级文档权限",
    "Enable plugins": "启用插件",
    "Enable document protection for": "为以下用户启用文档保护",
    "All users": "所有用户",
    "Owner only": "仅限所有者",
    "Authorization header (leave blank to use default header)": "授权标头 (留空以使用默认的标头)",
    "Euro-Office server is not available": "Euro-Office 服务器不可用",
    ...
    "Open file": "打开文件",
    "Euro-Office Document Server is unavailable": "Euro-Office 文档服务器不可用",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "此邮件是为了通知您，您与 Euro-Office 文档服务器的连接已丢失。请检查连接设置",
    "Go to Settings": "转到设置",
    ...
    "Welcome to Euro-Office Docs!": "欢迎使用 Euro-Office 文档！",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using Euro-Office Docs.": "在 Nextcloud 中使用 Euro-Office 文档编辑和协作处理文本文档、电子表格、演示文稿和 PDF 文件。",
    "Learn more": "了解更多",
    ...
    "To ensure the security of important parameters in Euro-Office Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "为确保 Euro-Office 文档请求中重要参数的安全，请在“设置”页面设置密钥。要了解更多信息，请<a href=\"{url}\" target=\"_blank\">点击此处</a>。",
    "Info": "信息",
    "Open": "打开",
