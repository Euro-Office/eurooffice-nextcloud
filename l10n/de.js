OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Euro-Office App ist nicht konfiguriert. Bitte wende Dich an Deinen Administrator",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Euro-Office ist zurzeit nicht erreichbar.  Bitte wende Dich an Deinen Administrator",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "Der 30-tägige Testzeitraum ist abgelaufen. Du kannst keine Verbindung mehr zu Demo Euro-Office Docs Server herstellen.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Du verwendest den öffentlichen Demo Euro-Office Docs Server. Bitte benutze ihn nicht zum Speichern von Deinen privaten sensiblen Daten.",
