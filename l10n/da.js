OC.L10N.register(
    ...
    "Euro-Office app is not configured. Please contact admin" : "Euro-Office-appen er ikke konfigureret. Kontakt venligst administrator",
    ...
    "Euro-Office cannot be reached. Please contact admin" : "Euro-Office kan ikke nås. Kontakt venligst administrator",
    "Loading, please wait." : "Indlæser... vent venligst.",
    "File created" : "Fil oprettet",
    "Open in Euro-Office" : "Åben i Euro-Office",
    "Convert with Euro-Office" : "Konverter med Euro-Office",
    ...
    "Euro-Office Docs Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Euro-Office Docs Lokation angiver adressen på serveren med dokumenttjenesterne installeret. Skift venligst '<dokumentserver>' for serveradressen i linjen nedenfor.",
    "Euro-Office Docs address" : "Euro-Office Docs-adresse",
    "Advanced server settings" : "Avancerede serverindstillinger",
    "Euro-Office Docs address for internal requests from the server" : "Euro-Office Docs-adresse for interne anmodninger fra serveren",
    "Server address for internal requests from Euro-Office Docs" : "Serveradresse for interne anmodninger fra Euro-Office Docs",
    ...
    "Save" : "Gem",
    "Mixed Active Content is not allowed. HTTPS address for Euro-Office Docs is required." : "Blandet aktivt indhold er ikke tilladt. HTTPS-adresse for Euro-Office Docs er påkrævet.",
    ...
    "Connect to demo Euro-Office Docs server" : "Opret forbindelse til demo Euro-Office Docs-server",
    ...
    "The 30-day test period is over, you can no longer connect to demo Euro-Office Docs server." : "30-dages testperioden er forbi, du kan ikke længere oprette forbindelse til demo Euro-Office Docs-server.",
    "You are using public demo Euro-Office Docs server. Please do not store private sensitive data." : "Du bruger den offentlige demo Euro-Office Docs-server. Gem venligst ikke private følsomme data.",
    ...
    "Use Euro-Office to generate a document preview (it will take up disk space)": "Brug Euro-Office til at generere et dokumenteksempel (...dette vil optage diskplads)",
    ...
    "group": "gruppe",
    "Advanced": "Avanceret",
    "Provide advanced document permissions using Euro-Office Docs": "Giv avancerede dokumenttilladelser ved brug af Euro-Office",
    ...
    "Euro-Office server is not available": "Euro-Office-serveren er ikke tilgængelig",
    ...
    "Open file": "Åbn fil",
    "Euro-Office Document Server is unavailable": "Euro-Office-dokumentserveren er ikke tilgængelig",
    "This is a mail message to notify that the connection with the Euro-Office Document Server has been lost. Please check the connection settings:": "Dette er en e-mailbesked, der giver besked om, at forbindelsen til Euro-Office-dokumentserveren er blevet afbrudt. Kontroller venligst forbindelsesindstillingerne:",
