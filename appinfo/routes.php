...
return [
    "routes" => [
       ...
       ["name" => "font#index",      "url" => "/ajax/fonts",           "verb" => "GET"],
       ["name" => "font#upload",     "url" => "/ajax/fonts",           "verb" => "POST"],
       ["name" => "font#delete",     "url" => "/ajax/fonts/{name}",    "verb" => "DELETE"],
       ["name" => "font#regenerate", "url" => "/ajax/fonts/regenerate","verb" => "POST"],
       ["name" => "font#get_status", "url" => "/ajax/fonts/status",    "verb" => "GET"],
