...
/**
 * Delegatable settings for the common templates administration form
 */
class AdminSettingsTemplates implements IDelegatedSettings {
    ...
    public function getForm(): TemplateResponse {
        ...
        return $container->get(SettingsController::class)->indexTemplates();
    }
    ...
    public function getName(): ?string {
        return $this->l10n->t("Templates");
    }

    /**
     * Common templates are files below TemplateManager::getGlobalTemplateDir(),
     * there are no app config keys backing this form.
     */
    #[\Override]
